...
@protocol CircularCollectionViewDataSource <NSObject>
...
@protocol CircularCollectionViewDelegate <NSObject>
...
@interface KBCircularCollectionView : UICollectionView

//The height of the collectionview cell in colapsed mode
@property (nonatomic, assign) NSInteger collapsedHeight;

//The height of the collectionview cell in expanded mode
@property (nonatomic, assign) NSInteger expandedHeight;

//Used to set the top and bottom distance between a cell
@property (nonatomic, assign) NSInteger minimumLineSpacing;

//This will be used for future enhancement for horizontal scroll. User can set Yes/No to this value in their storyboard's collection view
@property (assign) IBInspectable BOOL shouldScrollVertically;


@property (nonatomic, weak) id<CircularCollectionViewDataSource>  circularCollectionViewDataSource;
@property (nonatomic, weak)id<CircularCollectionViewDelegate>  circularCollectionViewDelegate;
